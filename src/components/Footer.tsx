      ...
      <div className="max-w-7xl mx-auto h-container">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} transition={{ duration: 0.6, delay: 0.4 }} viewport={{ once: true }} className="space-y-6">
            ...
            <p className="text-gray-600">Subscribe to get latest property, blog news from us</p>
            ...
            <motion.div className="relative" whileHover={{ scale: 1.02 }}>
              ...
              />
              <motion.button whileHover={{ scale: 1.1 }} whileTap={{ scale: 0.95 }} className="absolute right-2 top-1/2 -translate-y-1/2 bg-red-600 rounded-full p-2 text-white">
