    ...
    <div className="w-full">
      ...
      <div className="h-container md:px-20">
        <div className="flex flex-col items-center mt-10">
          <h2 className="text-white text-center font-rubik text-4xl md:text-5xl font-bold leading-normal tracking-[0.1px] mb-10 sm:mb-16">What is Housyy Hot Deals?</h2>
